            ...
            ->components([
                ...
                Placeholder::make('estoque_disponivel')
                    ...
                    ->content(function (callable $get): string {
                        ...
                        if (!$estoque) return '⚠ Produto sem estoque cadastrado';

                        $solicitado  = (int) ($get('quantidade') ?? 0);
                        $disponivel  = $estoque->quantidade;

                        if ($solicitado > $disponivel) {
                            return "❌ Insuficiente — disponível: {$disponivel} un.";
                        }

                        return "✓ Disponível: {$disponivel} un.";
                    }),
