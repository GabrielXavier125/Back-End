<x-app-layout title="Editar Turma">
<div class="py-4 max-w-lg">
    ...
    <div class="bg-white rounded-xl shadow-sm p-6">
        <h2 class="text-lg font-bold text-gray-800 mb-5">Editar Turma</h2>
        <form method="POST" action="{{ route('classrooms.update', $classroom) }}" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="name" value="{{ old('name', $classroom->name) }}" required class="w-full border-gray-300 rounded-lg text-sm focus:ring-blue-500 focus:border-blue-500">
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Série/Ano *</label>
                <input type="text" name="grade" value="{{ old('grade', $classroom->grade) }}" required class="w-full border-gray-300 rounded-lg text-sm focus:ring-blue-500 focus:border-blue-500">
            </div>
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="number" name="year" value="{{ old('year', $classroom->year) }}" min="2020" max="2099" required class="w-full border-gray-300 rounded-lg text-sm focus:ring-blue-500 focus:border-blue-500">
                </div>
            </div>
