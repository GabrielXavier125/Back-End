        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-lg rounded-2xl overflow-hidden">
                <div class="p-6 border-b border-gray-200">
                    <h3 class="text-lg font-semibold text-gray-700">Cadastro de Pedido</h3>
                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('pedidos.store') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="quantidade" name="quantidade" type="number" min="1" class="mt-1 block w-full" :value="old('quantidade', 1)" required />
