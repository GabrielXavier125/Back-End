        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-lg rounded-2xl overflow-hidden">
                <div class="p-6 border-b border-gray-200">
                    <h3 class="text-lg font-semibold text-gray-700">Atualização de Estoque</h3>
                    <div class="mt-2 text-sm text-gray-500">
                        <a href="{{ route('estoques.index') }}" class="text-indigo-600 hover:text-indigo-900">&larr; Voltar à lista</a>
                    </div>
                </div>

                <div class="p-6">
                    <form method="POST" action="{{ route('estoques.update', $estoque->id) }}" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div>
                            ...
                            <x-text-input id="quantidade" name="quantidade" type="number" min="0" class="mt-1 block w-full" :value="old('quantidade', $estoque->quantidade)" required />
